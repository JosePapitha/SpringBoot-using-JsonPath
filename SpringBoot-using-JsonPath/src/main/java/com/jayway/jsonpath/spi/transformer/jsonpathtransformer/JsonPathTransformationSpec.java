...
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_ADDITIONAL_TRANSFORM;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_CONSTANT_NOT_SCALAR;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_JSON_PATH;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_LOOKUP_TABLE_REF;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_OPERATOR;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_OPERATOR_WITH_SRC_NULL;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_UNARY_OPERATOR;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.INVALID_WILDCARD_ARRAY_MAPPING;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.MISSING_OPERAND_FOR_BINARY_OPERATOR;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.MISSING_OPERATOR;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.MISSING_TABLE_DATA;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.MISSING_TABLE_NAME;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.NULL_ADDITIONAL_TRANSFORM;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.NULL_SOURCE;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.NULL_TARGET;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.PATH_NEITHER_DEFINITE_NOR_WILDCARD_ARRAY;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.UNSUPPORTED_WILDCARD_PATH;
import static com.jayway.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.getStringFromBundle;
...
public class JsonPathTransformationSpec implements TransformationSpec {
    ...
    private Collection<? extends ValidationError> validateDefinitePathsAndArrayWildCardRules() {
        List<ValidationError> response = new ArrayList<>();
    ...
    static boolean isScalar(Object srcValue) {
        if ((srcValue == null) || WRAPPER_TYPES.contains(srcValue.getClass())) {
            return true;
        }
